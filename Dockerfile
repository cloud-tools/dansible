...
RUN yum -y install epel-release.noarch centos-release-openshift-origin.noarch \
    ...
    && pip install ansible==2.4.3.0 python-openstackclient python-neutronclient python-novaclient python-heatclient python-cinderclient setuptools boto --upgrade \
